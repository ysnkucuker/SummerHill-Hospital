...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "C:/Users/yasin/Desktop/Yeni klasör/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "C:/Users/yasin/Desktop/Yeni klasör/deployment"
        }),
        copy({
            targets: [
              { src: 'C:/Users/yasin/Desktop/Yeni klasör/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
